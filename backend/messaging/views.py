...
class MessageListCreateView(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        if current_user_id:
            ...
            return Message.objects.filter(Q(sender_id=current_user_id) | Q(recipient_id=current_user_id)).order_by('created_at')
    ...
    def create(self, request, *args, **kwargs):
        ...
        # Request.user should already be populated by the JWTAuthentication class,
        # and the serializer will attach the sender automatically.
